...
if(isset($_POST['post'])){
   ...
   $image_02_folder = 'images/'.$rename_image_02;
   ...
   $image_03_folder = 'images/'.$rename_image_03;
   ...
   $image_04_folder = 'images/'.$rename_image_04;
   ...
   $image_05_folder = 'images/'.$rename_image_05;
   ...
   $image_01_folder = 'images/'.$rename_image_01;
